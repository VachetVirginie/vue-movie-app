      ...
      <v-card>
        ...
        <v-list>
          <v-list-item>
            ...
            <v-list-item-title>Change mode color</v-list-item-title>
          </v-list-item>
        </v-list>
